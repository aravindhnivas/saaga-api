    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('linelist', models.ForeignKey(blank=True, db_constraint=False, null=True,
                 on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.linelist')),
                ('species', models.ForeignKey(blank=True, db_constraint=False, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('molecular_mass', core.models.ArbitraryDecimalField()),
                ('smiles', models.CharField(max_length=255)),
                ('standard_inchi', models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('meta', models.ForeignKey(blank=True, db_constraint=False, null=True,
                 on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.speciesmetadata')),
                ('ref', models.ForeignKey(blank=True, db_constraint=False, null=True,
